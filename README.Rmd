...
periods (the confounding discontinuity is 1 in both) and period 3 is the RD
period, where the treatment of interest adds 1 at the cutoff.
...
The vignettes walk through the estimator, its bandwidth rules and sampling
schemes, and the composition validation tests:
